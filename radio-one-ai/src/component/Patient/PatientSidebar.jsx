      ...
      <ul className="menu flex-grow px-4 gap-2 text-base font-medium">
        <li>
          <Link
            ...
            className={`rounded-xl p-3 ${getLinkClass("/patient/dashboard")}`}
          >
            <svg
        ...
        <li>
          <Link
            to="/patient/reports"
            className={`rounded-xl p-3 ${getLinkClass("/patient/reports")}`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
        ...
        <div className="bg-base-200/50 rounded-2xl p-2 space-y-1">
          <ul className="menu text-sm">
            ...
            <li>
              <Link
                to="/patient/settings"
                className={`rounded-lg ${getLinkClass("/patient/settings")}`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5"
