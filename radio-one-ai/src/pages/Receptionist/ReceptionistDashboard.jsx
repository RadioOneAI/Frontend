      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
          <h1 className="text-4xl font-black tracking-tight mb-2">
            Reception <span className="text-gradient">Dashboard</span>
          </h1>
          <p className="text-base-content/60 font-medium mt-1">Welcome back, Receptionist. Here is today's system summary.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 dashboard-section glass bg-base-100/40 backdrop-blur-xl border border-white/10 rounded-[2rem] overflow-hidden shadow-xl">
          <div className="p-8 border-b border-white/5 flex justify-between items-center">
            ...
            <button className="btn btn-sm btn-ghost rounded-xl hover:bg-white/5 uppercase text-[10px] font-black tracking-widest">View Full Log</button>
          </div>
          ...
          <div className="dashboard-section glass bg-base-100/40 backdrop-blur-xl border border-white/10 rounded-[2rem] p-8 shadow-xl">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                { to: "/admin/radiologists", label: "Add Radio..", color: "hover:bg-purple-500/10 hover:text-purple-400" },
                { to: "/admin/patients", label: "New Patient", color: "hover:bg-pink-500/10 hover:text-pink-400" },
                { to: "/admin/settings", label: "System Logs", color: "hover:bg-slate-500/10 hover:text-slate-400" },
              ].map((link, idx) => (
