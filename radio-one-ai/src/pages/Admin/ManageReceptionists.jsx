...
export default function ManageReceptionists() {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      setToast({
        message: error.message || "Unable to fetch receptionists.",
        type: "error",
      });
    } finally {
      setIsLoading(false);
  ...
  const handleViewDetails = (r) => {
    ...
    setTimeout(() => {
      document.getElementById("view_receptionist_modal").showModal();
    }, 0);
  };
      ...
      <div className="page-header flex justify-between items-center">
        <div>
          ...
          <p className="text-base-content/50 font-medium">
            Manage front-desk staff and coordination team.
          </p>
        </div>
              ...
              {isLoading ? (
                ...
                filtered.map((r) => (
                  ...
                  >
                    ...
                    <td>
                      <span className="font-mono font-black text-xs text-info bg-info/5 px-3 py-1.5 rounded-lg border border-info/10">
                        {r.phone}
                      </span>
                    </td>
                    <td>
