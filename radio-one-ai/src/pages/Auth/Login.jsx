    ...
    <div className="flex items-center justify-center min-h-[80vh] bg-base-100 px-4">
      <div className="card w-full max-w-md shadow-2xl bg-base-200">
        <div className="card-body">
          ...
          <button className="btn btn-outline w-full gap-2">Continue with Google</button>
          <p className="text-center text-sm mt-4">
            Don't have an account? <Link to="/signup" className="link link-primary font-semibold">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
