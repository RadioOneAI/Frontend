    ...
    <div ref={container} className="space-y-8 p-4">
      ...
      <div className="page-header flex justify-between items-center">
        <div>
          ...
          <p className="text-base-content/50 font-medium">
            Manage clinical registration and admission records.
          </p>
        </div>
        <button
          onClick={() =>
      ...
      <dialog id="add_patient_modal" className="modal overflow-hidden">
        <div className="modal-box w-11/12 max-w-2xl p-0 rounded-[3rem] border-none bg-white shadow-2xl overflow-hidden relative">
          <form method="dialog">
            <button className="btn btn-sm btn-circle btn-ghost absolute right-8 top-8 z-50 bg-base-200/50 hover:bg-base-200 transition-colors">
              ✕
            </button>
          </form>
          ...
          <div className="p-12 space-y-8">
            <div>
              <h3 className="text-3xl font-black tracking-tighter text-slate-900 leading-tight">
                Patient Registration
              </h3>
              <p className="text-slate-400 font-bold text-xs uppercase tracking-widest mt-2">
                Create new clinical admission record
              </p>
            </div>
            ...
            <form onSubmit={handleAddPatient} className="space-y-6">
              <div className="grid grid-cols-2 gap-6">
                <div className="form-control">
                  ...
                  <input
                    ...
                    className="input input-ghost font-bold bg-slate-50 focus:bg-slate-100 rounded-2xl h-14"
                    required
                  />
                </div>
                <div className="form-control">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="form-control">
                  ...
                  <select
                    name="gender"
                    className="select select-ghost font-bold bg-slate-50 focus:bg-slate-100 rounded-2xl h-14"
                    required
                    defaultValue=""
                  >
              ...
              <div className="pt-6">
                <button
                  type="submit"
                  className="btn btn-primary w-full h-16 rounded-2xl font-black uppercase tracking-[0.2em] shadow-2xl shadow-primary/30 border-none text-xs"
        ...
        <form
          method="dialog"
          className="modal-backdrop bg-slate-900/40 backdrop-blur-md"
        >
          <button>close</button>
        </form>
      </dialog>
