    ...
    <div className="h-full flex flex-col bg-base-100 w-80 border-r border-base-300">
      ...
      <div className="p-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-base-content/50 uppercase tracking-widest font-semibold">Receptionist</p>
        </div>
      </div>
      ...
      <ul className="menu flex-grow px-4 gap-2 text-base font-medium">
        ...
        {/* Dashboard */}
        <li>
          <Link to="/receptionist/dashboard" className={`rounded-xl p-3 ${getLinkClass("/receptionist/dashboard")}`}>
        ...
        {/* Patients */}
        <li>
          <Link to="/receptionist/patients" className={`rounded-xl p-3 ${getLinkClass("/admin/patients")}`}>
      ...
      <div className="p-4 mt-auto">
        <div className="bg-base-200/50 rounded-2xl p-2 space-y-1">
          ...
          <ul className="menu text-sm">
            ...
            <li>
              <Link to="/receptionist/settings" className={`rounded-lg ${getLinkClass("/receptionist/settings")}`}>
            ...
            <li>
            <Link to="/receptionist/logs" className={`rounded-lg ${getLinkClass("/receptionist/logs")}`}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
