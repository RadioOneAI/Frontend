      ...
      <div className="page-header flex justify-between items-center">
        <div>
          <h1 className="text-4xl font-black tracking-tight mb-2">
            System Audit <span className="text-gradient">Logs</span>
          </h1>
          <p className="text-base-content/50 font-medium">Real-time tracking of clinical activities and security events.</p>
        </div>
          ...
          <table className="table table-zebra w-full text-center">
            <thead>
              <tr className="text-base-content/40 uppercase tracking-widest text-[10px] font-black border-b border-base-content/5">
                ...
                <th className="py-6">Activity / Action</th>
