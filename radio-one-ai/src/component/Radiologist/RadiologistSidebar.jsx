    ...
    <div className="h-full flex flex-col bg-base-100 w-50 border-r border-base-300">
      <div className="p-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-base-content/50 uppercase tracking-widest font-semibold">Radiologist</p>
        </div>
      </div>

      <ul className="menu flex-grow px-4 gap-2 text-base font-medium">
        <li>
          <Link to="/radiologist/dashboard" className={`rounded-xl p-3 ${getLinkClass("/radiologist/dashboard")}`}>
        ...
        <li>
          <Link to="/radiologist/appointments" className={`rounded-xl p-3 ${getLinkClass("/radiologist/appointments")}`}>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      <div className="p-4 mt-auto">
        <div className="bg-base-200/50 rounded-2xl p-2 space-y-1">
          <ul className="menu text-sm">
            ...
            <li>
              <Link to="/radiologist/settings" className={`rounded-lg ${getLinkClass("/radiologist/settings")}`}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            <li>
              <Link to="/radiologist/logs" className={`rounded-lg ${getLinkClass("/radiologist/logs")}`}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
