    ...
    <BrowserRouter>
      <Layout>
        <Routes>
          ...
          <Route
            path="/admin/radiographers"
            element={<ManageRadiographers />}
          />{" "}
          {/* <--- 2. ROUTE ADDED */}
          ...
          <Route
            ...
            element={<ReceptionistManagePatients />}
          />
          <Route
          ...
          />
          <Route
            path="/receptionist/logs"
            element={<ReceptionistSystemLogs />}
          />
          {/* --- Radiographer Routes --- */}
          <Route
            path="/radiographer/dashboard"
            element={<RadiographerDashboard />}
          />
          <Route
            path="/radiographer/appointments"
            element={<RadiographerAppointments />}
          />
          <Route
            path="/radiographer/settings"
            element={<RadiographerSettings />}
          />
          <Route
            path="/radiographer/logs"
            element={<RadiographerSystemLogs />}
          />
          {/* --- Radiologist Routes --- */}
          <Route
          ...
          />
          <Route
            path="/radiologist/appointments"
            element={<RadiologisAppointment />}
          />
          <Route
            path="/radiologist/settings"
            element={<RadiologistSettings />}
          />
